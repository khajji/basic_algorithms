...
public class UnboundedKnapsack {
	 ...
	 */
	public static ArrayList<Integer> unboundedKnapsack(int[] v, int[] w, int c){
		int[] maxValues = new int[c+1]; //stores the optimal values for the weights 0,..,c
		int[] lastSelected = new int[c+1]; lastSelected[0]=-1; //stores the index of the last collected item in the optimal soltuion of weights 0,...,c		
		for(int i= 1; i<=c; i++){
	...
	private static ArrayList<Integer> collectObjects (int [] w, int[] selectedObjects){
	...
	public static void main(String[] args) {
		...
		int c = 10;
		System.out.println("the ids of the selected objects are :"+ UnboundedKnapsack.unboundedKnapsack(v, w, c));
	}
